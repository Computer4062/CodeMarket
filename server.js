...
app.post('/pay', async (req, res) => {
    ...
    const url = "https://comfortable-hen-jodhpurs.cyclic.app/payment/success" + querystring.stringify({query:`/${html}/${css}/${js}`})
    const session = await Stripe.checkout.sessions.create({
        ...
        mode: "payment",
        success_url: url,
        cancel_url: "https://comfortable-hen-jodhpurs.cyclic.app/payment/cancel"
      });
